...
const showProgressBar = computed(() =>
    [DealEnum.accepted, DealEnum.payed, DealEnum.payment_confirmation_expired].includes(dealType.value)
)
  ...
  switch (dealType.value) {
    ...
    case DealEnum.accepted:
      return [
          ...
          'Платеж будет автоматически отменем, если кнопка не будет нажата в установленные сроки'
      ];
    case DealEnum.payed:
