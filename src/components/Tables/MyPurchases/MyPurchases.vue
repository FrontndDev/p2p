<template>
  <div class="my-table my-purchases">
    <div class="my-purchases__row my-table__row my-table__row_headers">
      <div>Продавец</div>
    ...
    <div class="my-purchases__row my-table__row" v-for="row in table" :key="row.id">
      <div class="my-purchases__seller">
        <img
            ...
            alt="avatar"
            class="my-purchases__seller-avatar"
        >

        <div class="my-purchases__seller-name" :title="row.name">{{ row.name }}</div>
      </div>
      <div class="my-purchases__info">
        <div class="my-purchases__info-count">
          {{ row.count }}
          <component :is="getIcon(row.wallet)"/>
        </div>
        <div class="my-purchases__info-sum">{{ row.sum }} RUB</div>
      </div>
      <div class="my-purchases__status" :class="row.status">{{ StatusesEnum[row.status] }}</div>
      <div class="my-purchases__order-id">
