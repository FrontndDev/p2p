<template>
  <div class="requisites p2p-card">
    ...
    <div class="requisites__content">
      <div class="requisites__item" v-for="item in 3" :key="item">
        <div class="requisites__item-wallet">
          <img src="@/assets/images/rub.png" alt="icon">
          RUB
        </div>

        <div class="requisites__item-bank">ТИНЬКОФФ</div>
        <div class="requisites__item-card-num">4523 *** **** 0254</div>
        <div class="requisites__item-edit">
